"""
blender_import_6rotors.py  — run inside Blender's scripting tab.
Requires: kinematics_6rotors.csv in the same directory as this script.
...
CSV = Path(__file__).parent / "kinematics_6rotors.csv"
