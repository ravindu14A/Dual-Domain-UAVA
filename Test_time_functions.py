...
def get_velocity_rgb_spiral(v_kin_vert, v_kin_horiz, R, w_flat, w_arc, gsd, max_blur, shutter, overlap, fps):
    theta = math.atan(w_flat / (2 * math.pi * R))
    v_kin_path = min(v_kin_vert / math.sin(theta), v_kin_horiz / math.cos(theta))
